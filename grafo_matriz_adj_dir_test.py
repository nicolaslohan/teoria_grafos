...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #Clone do grafo da paraíba com mudança na sexta aresta e adição da décima aresta para teste de Dijkstra
        self.g_pp = MeuGrafo()
        self.g_pp.adiciona_vertice("J")
        self.g_pp.adiciona_vertice("C")
        self.g_pp.adiciona_vertice("E")
        self.g_pp.adiciona_vertice("P")
        self.g_pp.adiciona_vertice("M")
        self.g_pp.adiciona_vertice("T")
        self.g_pp.adiciona_vertice("Z")
        self.g_pp.adiciona_aresta('a1', 'J', 'C')
        self.g_pp.adiciona_aresta('a2', 'C', 'E')
        self.g_pp.adiciona_aresta('a3', 'C', 'E')
        self.g_pp.adiciona_aresta('a4', 'P', 'C')
        self.g_pp.adiciona_aresta('a5', 'P', 'C')
        self.g_pp.adiciona_aresta('a6', 'T', 'C')
        self.g_pp.adiciona_aresta('a7', 'C', 'M')
        self.g_pp.adiciona_aresta('a8', 'M', 'T')
        self.g_pp.adiciona_aresta('a9', 'T', 'Z')
        self.g_pp.adiciona_aresta('a10', 'C', 'T')
        ...
        # Grafo utilizado como exemplo em sala de aula para Dijkstra
        self.grafo_aula = MeuGrafo()
        self.grafo_aula.adiciona_vertice("A")
        self.grafo_aula.adiciona_vertice("B")
        self.grafo_aula.adiciona_vertice("C")
        self.grafo_aula.adiciona_vertice("D")
        self.grafo_aula.adiciona_vertice("E")
        self.grafo_aula.adiciona_vertice("F")
        self.grafo_aula.adiciona_aresta("a1", "A", "B", 2)
        self.grafo_aula.adiciona_aresta("a2", "A", "C", 1)
        self.grafo_aula.adiciona_aresta("a3", "B", "D", 1)
        self.grafo_aula.adiciona_aresta("a4", "C", "D", 3)
        self.grafo_aula.adiciona_aresta("a5", "C", "F", 15)
        self.grafo_aula.adiciona_aresta("a6", "D", "E", 2)
        self.grafo_aula.adiciona_aresta("a7", "E", "F", 3)

        # Grafo video aula para Dijkstra
        self.grafo_video = MeuGrafo()
        self.grafo_video.adiciona_vertice("A")
        self.grafo_video.adiciona_vertice("B")
        self.grafo_video.adiciona_vertice("C")
        self.grafo_video.adiciona_vertice("D")
        self.grafo_video.adiciona_vertice("E")
        self.grafo_video.adiciona_vertice("F")
        self.grafo_video.adiciona_vertice("G")
        self.grafo_video.adiciona_aresta("a1", "A", "B", 1)
        self.grafo_video.adiciona_aresta("a2", "B", "C", 1)
        self.grafo_video.adiciona_aresta("a3", "C", "D", 1)
        self.grafo_video.adiciona_aresta("a4", "D", "E", 3)
        self.grafo_video.adiciona_aresta("a5", "E", "G", 2)
        self.grafo_video.adiciona_aresta("a6", "C", "E", 2)
        self.grafo_video.adiciona_aresta("a7", "B", "F", 3)
        self.grafo_video.adiciona_aresta("a8", "F", "G", 1)
        ...
        self.grafo_drone.adiciona_vertice("A1")
        self.grafo_drone.adiciona_vertice("A2")
        self.grafo_drone.adiciona_vertice("A3")
        self.grafo_drone.adiciona_vertice("A4")
        self.grafo_drone.adiciona_vertice("A5")
        self.grafo_drone.adiciona_vertice("A6")
        self.grafo_drone.adiciona_aresta("a1", "A", "B")
        self.grafo_drone.adiciona_aresta("a2", "A", "D")
        self.grafo_drone.adiciona_aresta("a3", "A", "E")
        self.grafo_drone.adiciona_aresta("a4", "B", "C")
        self.grafo_drone.adiciona_aresta("a5", "D", "G")
        self.grafo_drone.adiciona_aresta("a6", "E", "D")
        self.grafo_drone.adiciona_aresta("a7", "C", "F")
        self.grafo_drone.adiciona_aresta("a8", "F", "B")
        self.grafo_drone.adiciona_aresta("a9", "F", "I")
        self.grafo_drone.adiciona_aresta("a10", "B", "J")
        self.grafo_drone.adiciona_aresta("a11", "G", "F")
        self.grafo_drone.adiciona_aresta("a12", "E", "H")
        self.grafo_drone.adiciona_aresta("a13", "H", "L")
        self.grafo_drone.adiciona_aresta("a14", "G", "I")
        self.grafo_drone.adiciona_aresta("a15", "G", "K")
        self.grafo_drone.adiciona_aresta("a16", "I", "J")
        self.grafo_drone.adiciona_aresta("a17", "J", "P")
        self.grafo_drone.adiciona_aresta("a18", "I", "O")
        self.grafo_drone.adiciona_aresta("a19", "K", "M")
        self.grafo_drone.adiciona_aresta("a20", "L", "N")
        self.grafo_drone.adiciona_aresta("a21", "N", "O")
        self.grafo_drone.adiciona_aresta("a22", "O", "S")
        self.grafo_drone.adiciona_aresta("a23", "P", "S")
        self.grafo_drone.adiciona_aresta("a24", "S", "T")
        self.grafo_drone.adiciona_aresta("a25", "O", "R")
        self.grafo_drone.adiciona_aresta("a26", "P", "Q")
        self.grafo_drone.adiciona_aresta("a27", "R", "Q")
        self.grafo_drone.adiciona_aresta("a28", "S", "R")
        self.grafo_drone.adiciona_aresta("a29", "T", "U")
        self.grafo_drone.adiciona_aresta("a30", "T", "V")
        self.grafo_drone.adiciona_aresta("a31", "R", "X")
        self.grafo_drone.adiciona_aresta("a32", "Q", "Y")
        self.grafo_drone.adiciona_aresta("a33", "V", "W")
        self.grafo_drone.adiciona_aresta("a34", "W", "S")
        self.grafo_drone.adiciona_aresta("a35", "W", "X")
        self.grafo_drone.adiciona_aresta("a36", "Y", "A1")
        self.grafo_drone.adiciona_aresta("a37", "Y", "Z")
        self.grafo_drone.adiciona_aresta("a38", "X", "A2")
        self.grafo_drone.adiciona_aresta("a39", "Z", "A4")
        self.grafo_drone.adiciona_aresta("a40", "A4", "A3")
        self.grafo_drone.adiciona_aresta("a41", "X", "A1")
        self.grafo_drone.adiciona_aresta("a42", "V", "A3")
        self.grafo_drone.adiciona_aresta("a43", "A3", "A6")
        self.grafo_drone.adiciona_aresta("a44", "A3", "A5")
    ...
    def test_dijkstra(self):
        ...
        self.assertEqual(self.grafo_aula.dijkstra("A", "D"), ['A', 'B', 'D'])
        self.assertEqual(self.grafo_video.dijkstra("A", "G"), ['A', 'B', 'F', 'G'])
        self.assertEqual(self.grafo_video.dijkstra("B", "E"), ['B', 'C', 'E'])
        self.assertEqual(self.grafo_drone.dijkstra("A", "A6"), ['A', 'B', 'J', 'P', 'S', 'T', 'V', 'A3', 'A6'])
        self.assertEqual(self.grafo_drone.dijkstra("F", "A5"), ['F', 'I', 'O', 'S', 'T', 'V', 'A3', 'A5'])
        self.assertEqual(self.g_pp.dijkstra("J", "M"), ['J', 'C', 'M'])
        self.assertEqual(self.g_pp.dijkstra("J", "Z"), ['J', 'C', 'T', 'Z'])
